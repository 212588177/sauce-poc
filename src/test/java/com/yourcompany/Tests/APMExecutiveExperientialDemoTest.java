...
public class APMExecutiveExperientialDemoTest extends TestBase {
    ...
    public void APMExecutiveExperientialDemoTest(String browser, String version, String os, Method method)
        ...
        ExperientialDemoForm theForm = new ExperientialDemoForm(driver, 4671, true, "demoPersona", "Executive");
        theForm.setRedirectBehavior(true);
        theForm.setRedirectDestination("https://www.ge.com/digital/sd/exec-apm-demo/#/");
